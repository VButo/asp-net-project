...
namespace API_tester.Migrations.Identity
{
    public partial class IdentityInit : Migration
    {
        ...
        {
            // Identity columns on `users` are assumed to be present or handled separately.
            ...
            // Ensure Id columns are AUTO_INCREMENT where needed (in case provider didn't set generation)
            migrationBuilder.Sql("ALTER TABLE `AspNetRoles` MODIFY COLUMN `Id` int NOT NULL AUTO_INCREMENT;");
            migrationBuilder.Sql("ALTER TABLE `AspNetRoleClaims` MODIFY COLUMN `Id` int NOT NULL AUTO_INCREMENT;");
            migrationBuilder.Sql("ALTER TABLE `AspNetUserClaims` MODIFY COLUMN `Id` int NOT NULL AUTO_INCREMENT;");
        }
